    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <div className="fixed inset-0 bg-black/50" onClick={step !== 'generating' ? close : undefined} />
          <div
            ref={dialogRef}
            role="dialog"
            aria-modal="true"
          ...
          >
            ...
            <div className="flex items-center justify-between border-b border-zinc-200 px-6 py-4 dark:border-zinc-800">
              <h3 id="post-review-title" className="text-lg font-semibold text-zinc-900 dark:text-zinc-100">
            ...
            <div className="flex-1 overflow-y-auto px-6 py-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    ...
                    >
                      ...
                      <p className="text-xs text-zinc-500 dark:text-zinc-400">
                        Rewrite as a single human voice — sounds like you wrote it.
                      </p>
                    </button>
                  </div>
              ...
              {/* Generating step — streaming content */}
              {step === 'generating' && (
                <div className="space-y-3">
                  {/* Status bar — always visible during generation */}
                  <div className="flex items-center gap-2 rounded-md border border-zinc-200 bg-zinc-50 px-3 py-2 text-xs text-zinc-600 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-400">
                    ...
                    <span className="truncate">
                      {toolStatus
                        ...
                        : streamingContent
                          ? 'Writing review...'
                          : 'Reading review files and preparing rewrite...'}
                    </span>
                  </div>
              ...
              {step === 'preview' && (
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-1 border-b border-zinc-200 dark:border-zinc-700">
                    ...
                    <button
                      onClick={() => {
                        setEditMode(true)
                        if (!editContent) {
                          setEditContent(generatedContent || savedHumanReview || finalContent)
                        }
                      }}
                      className={cn(
                        'inline-flex items-center gap-1.5 border-b-2 px-3 py-2 text-xs font-medium transition-colors',
                  ...
                  {editMode ? (
                    <textarea
                      value={editContent || generatedContent || savedHumanReview || finalContent}
            ...
            <div className="flex items-center justify-end gap-3 border-t border-zinc-200 px-6 py-4 dark:border-zinc-800">
              ...
              {step === 'preview' && (
                <>
                  ...
                  <button
                    onClick={() => saveDraft(sessionId, roundNumber, getPostContent())}
                    className="inline-flex items-center gap-1.5 rounded-md border border-zinc-200 px-3 py-1.5 text-sm font-medium text-zinc-700 transition-colors hover:bg-zinc-100 dark:border-zinc-700 dark:text-zinc-300 dark:hover:bg-zinc-800"
                  >
                  ...
                  <button
                    onClick={() => submitToGitHub(prNumber, getPostContent())}
